...
function Testimonial() {
  return (
    <section id='cleints' className={`${style.paddingY} ${style.flexCenter} flex-col relative`}>
      ...
      <h1 className={style.heading2}>
        ...
        <div className=" w-full md:mt-0 mt-6">
          <p className={`${style.para} text-left max-w-[450px]`}>
            Everything you need to accept card payments and grow 
            your buisiness anywhere on the planet</p>
        </div>
      </div>
