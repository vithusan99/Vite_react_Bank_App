const style={
    ...
    para:"font-poppins font-normal text-dimWhite text-[18px] leading-[30.8px]",

    flexCenter:"flex-center justify-center items-center",
    flexStart:"flex-center justify-center items-start",
